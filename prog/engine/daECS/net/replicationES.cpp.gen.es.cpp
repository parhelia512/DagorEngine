...
static ecs::LTComponentList replication_component(ECS_HASH("replication"), replication_get_type(), "prog/engine/daECS/net/replicationES.cpp.inl", "", 0);
...
(
  ...
  "prog/engine/daECS/net/replicationES.cpp.inl",
