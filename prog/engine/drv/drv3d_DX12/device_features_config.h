...
struct DeviceFeaturesConfig
{
  enum Bits
  {
    ...
    ENABLE_DEFRAGMENTATION_ON_PANIC_BUDGET,
    ENABLE_EMERGENCY_DEFRAGMENTATION,
    USE_RECOMPOSITION_EMERGENCY_DEFRAGMENTATION,
    ALLOW_ASYNC_PSO_COMPILATION,
    FORCE_SHARED_HEAPS_USER_ALIAS_RESOURCES,
    USE_COMMITTED_RESOURCES_FOR_TEXTURES,
