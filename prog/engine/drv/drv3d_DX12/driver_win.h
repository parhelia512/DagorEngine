...
#define DX12_VALIDATE_COPY_COMMAND_LIST     (DAGOR_DBGLEVEL > 0)
...
#define DX12_HAS_OMM_INTERFACE (((D3D12_SDK_VERSION >= 616) && (D3D12_SDK_VERSION < 700)) || (D3D12_SDK_VERSION >= 716))
