...
static void burnt_ground_renderer_on_appear_es(const ecs::Event &,
  ...
  const SharedTexWithShaderVar &burnt_ground_renderer__tex_d,
  const SharedTexWithShaderVar &burnt_ground_renderer__tex_n,
  const SharedTexWithShaderVar &burnt_ground_renderer__tex_m,
