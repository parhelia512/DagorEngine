...
void showScreenKeyboardIME_iOS(const char *text, const char *hint, unsigned int ime_flag, unsigned int edit_flag, int cursor_pos,
  bool is_secure, int max_chars, void(on_finish_cb)(const char *str, int cursor));
