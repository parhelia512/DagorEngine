...
#define ECS_HASHLEN(a)                                                                                  \
  (ecs::HashedLenConstString({a, eastl::integral_constant<::ecs::hash_str_t, str_hash_fnv1a(a)>::value, \
    eastl::integral_constant<uint32_t, ::ecs::constexpr_strlen(a)>::value}))
#define ECS_HASHLEN_SLOW(a)        (::ecs::HashedLenConstString({a, str_hash_fnv1a(a), (uint32_t)strlen(a)}))
#define ECS_HASHLEN_SLOW_LEN(a, l) (::ecs::HashedLenConstString({a, mem_hash_fnv1a(a, (l)), (l)}))
...
struct TemplatesData : public TemplateComponentsDB
{
  ...
  typedef OAHashNameMap<false, FNV1AOAHasher<false>> NameMap;
