...
#define BIND_UINT_CONST(name) das::addConstant<uint32_t>(module, #name, name);
  ...
  BIND_INT_CONST(DISCARD_TARGET);
  BIND_INT_CONST(DISCARD_ZBUFFER);
  BIND_INT_CONST(DISCARD_STENCIL);
  BIND_INT_CONST(DISCARD_ALL);
  ...
  BIND_UINT_CONST(RP_TA_LOAD_STENCIL_READ)
  BIND_UINT_CONST(RP_TA_LOAD_STENCIL_CLEAR)
  BIND_UINT_CONST(RP_TA_LOAD_STENCIL_NO_CARE)
