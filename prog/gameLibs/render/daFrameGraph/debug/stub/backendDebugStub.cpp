...
void debug_rec_enhanced_buffer_barrier(ResNameId, int, int, int, const d3d::BufferBarrier &) {}
void debug_rec_enhanced_texture_barrier(ResNameId, int, int, int, const d3d::TextureBarrier &) {}
