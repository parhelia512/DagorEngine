...
public:
  struct Reprojection
  {
    friend class ScreenSpaceReflections;
...
public:
  ...
  Reprojection getReprojection() const;
  // Sets the reprojection shader vars for another pass that samples the same history the trace did.
  static void applyReprojection(const Reprojection &reprojection, const TMatrix &view_tm, const TMatrix4 &proj_tm,
