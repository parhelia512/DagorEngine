...
static void create_darg_nodes_es(const OnCameraNodeConstruction &evt)
{
  evt.nodes->push_back(makeOpaqueInWorldPanelsNode());
  evt.nodes->push_back(makeTranslucentInWorldPanelsNode());
}
