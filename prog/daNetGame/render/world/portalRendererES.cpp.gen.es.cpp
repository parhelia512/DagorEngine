...
inline void get_portal_renderer_manager_ecs_query(ecs::EntityManager &manager, ecs::EntityId eid, Callable function)
{
  perform_query(&manager, eid, get_portal_renderer_manager_ecs_query_desc.getHandle(),
