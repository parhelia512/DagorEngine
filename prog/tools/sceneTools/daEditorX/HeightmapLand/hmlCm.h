...
enum
{
  ...
  CM_HEIGHTMAP_TOOLBAR_PANEL_FIRST = CM_PLUGIN_BASE + 1, // The first toolbar panel on the Landscape toolbar.
  CM_HEIGHTMAP_TOOLBAR_PANEL_SECOND,
  CM_SHOW_PANEL,
...
enum
{
  CM_PREFERENCES_PLACE_TYPE = CM_PLUGIN_SETTINGS_BASE + 1,
  CM_PREFERENCES_PLACE_TYPE_DROPDOWN,
  CM_PREFERENCES_PLACE_TYPE_RADIO,
};
...
enum
{
  ...
  NM_PARAM_CELL_A_WALKABLE_CLIMB,
  ...
  NM_PARAM_TILE_SZ,
  NM_PARAM_BUCKET_SZ,
  NM_PARAM_INCLUDE_DETAILED_DATA,
  ...
  NM_PARAM_JLK_EDGE_MERGE_DIST_V1,
...
enum
{
  ...
  PID_APPLY_HEIGHTBAKE,
  PID_APPLY_HEIGHTBAKE_ON_EDIT,
  PID_REBAKE_HMAP_MODIFIERS,
  PID_CONVERT_DELAUNAY_SPLINES_TO_HEIGHTBAKE,
  // PID_MESH_CELL_SIZE,
  PID_MESH_CELLS,
  ...
  PID_RI_MIN_CELL_SIZE,
  PID_RI_MAX_CELL_SIZE,
  PID_RI_MAX_GEN_LAYER_CELL_DIVISOR,
